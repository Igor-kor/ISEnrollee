...
namespace TestProject2
{
    internal class Enrollee
    {
        ...
        public void Setup()
        {
             auth = new UserAuth("EnrolleeTest", "EnrolleeTest");
        ...
        {
            auth.ConnectToDB();
            Assert.IsTrue(UserAuth.isEnrollee, "Роль пользователя не Абитуриент!");
        }
        ...
        public void Test13()
        {
            ...
            Assert.Fail("У пользователя есть права на запись в таблиу person");
        }
